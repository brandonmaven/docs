...
Open the **Playground** from the sidebar. Select your app, gateway, and mode, enter a phone number and amount, and create a test session. You'll see the session status update in real time as the caller progresses through the IVR.
...
<CardGroup cols={2}>
  <Card title="VAPI Integration" icon="bot" href="/integrations/vapi-integration">
    Trigger payments from your VAPI voice AI agent.
  </Card>
  <Card title="Retell Integration" icon="phone" href="/integrations/retell-integration">
    Trigger payments from your Retell AI agent.
  </Card>
