...
description: Collect your first voice payment in 5 minutes
---
...
<Steps>
  ...
  <Step title="Connect a gateway">
    In your app, go to the **Payments** tab and connect one of 25+ supported gateways — Stripe, Adyen, Checkout.com, Braintree, Cybersource, Worldpay, Global Payments, J.P. Morgan, and [many more](/api-reference/overview#payment-gateways) — or forward the card to your own [PCI-compliant endpoint](/integrations/card-forwarding).
  </Step>
