...
Send customers a secure Stripe Checkout link instead of collecting payment over the phone.
...
| **Entry point** | Maven phone number (`phone_number`) | Stripe Checkout URL (`checkout_url`) |
