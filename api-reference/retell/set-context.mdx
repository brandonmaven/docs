---
title: "Set Context"
api: "POST /voice/api/v1/retell/set-context"
description: "Create a payment session for a Retell call"
---
...
Create a payment session for a Retell voice AI agent. The response includes the Maven phone number your agent should transfer the call to. Maven matches the caller by phone number and begins payment collection.
