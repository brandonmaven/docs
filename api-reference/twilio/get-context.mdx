---
title: "Get Context"
api: "POST /voice/api/v1/twilio/get-context"
description: "Get payment session status and result for a Twilio call"
---
...
```bash cURL
curl -X POST https://api.trymaven.com/voice/api/v1/twilio/get-context \
...
```javascript Node.js
const response = await fetch('https://api.trymaven.com/voice/api/v1/twilio/get-context', {
  method: 'POST',
  headers: {
...
response = requests.post(
    'https://api.trymaven.com/voice/api/v1/twilio/get-context',
