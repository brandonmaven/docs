...
<ParamField body="channel" type="string" default="voice">
  ...
  - `sms` — Returns a secure checkout link for browser payment
</ParamField>

<ParamField body="input_mode" type="string" default="dtmf">
  Input mode for voice IVR calls:
  - `dtmf` — Customer enters card digits using the phone keypad (default)
  - `asr` — Customer speaks card digits using voice recognition
</ParamField>
...
<ParamField body="customer_id" type="string">
  Your internal customer identifier (max 255 chars). Returned in webhooks for correlation.
</ParamField>
...
<ResponseField name="checkout_url" type="string">
  Checkout URL for the customer to pay. Only present for SMS channel.
</ResponseField>
