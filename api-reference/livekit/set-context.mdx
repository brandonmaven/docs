---
title: "Set Context"
api: "POST /voice/api/v1/livekit/set-context"
description: "Create a payment session for a LiveKit call"
---
...
Create a payment session for a LiveKit voice AI agent. The response includes the Maven phone number your agent should transfer the call to. Maven matches the caller by phone number and begins payment collection.
