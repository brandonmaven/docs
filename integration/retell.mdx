...
3. Use Retell's call transfer API to transfer the customer to Maven
...
Use Retell's call transfer API to transfer the customer to the Maven `phone_number` returned in the session response.
