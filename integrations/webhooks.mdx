...
Set a webhook URL per app in the [Maven Dashboard](https://prod.trymaven.com):
...
All webhook payloads use the same structure:
...
| `gateway` | string | `"stripe"`, `"authorizenet"`, or `"braintree"` |
