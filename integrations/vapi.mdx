...
<Tip>
  Need more parameters? You can add `email`, `full_name`, `currency`, or `metadata` to the tool. See the [Sessions API](/api-reference/sessions) for all available fields.
</Tip>
