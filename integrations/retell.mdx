...
<Steps>
  ...
  <Step title="Create the collect_payment function in Retell">
    ...
    ```json
    {
      ...
      "properties": {
        ...
        "memory": {
          "type": "string",
          "description": "Summary of the call so far to carry across the transfer"
        }
      },
      "required": ["amount"]
    }
  ...
  <Step title="Create the transfer_call function in Retell">
    ...
    ```json
    {
      ...
      "properties": {
        "transfer_number": {
          "type": "string",
          "description": "The phone number returned by collect_payment"
        }
      },
  ...
  <Step title="Add get_session and cancel_session (optional)">
    You can also add these using the same webhook URL:

    **get_session** — Look up a session by phone number:
    ```json
    {
      "type": "object",
      "properties": {
    ...
    **cancel_session** — Cancel a pending session:
    ```json
    {
      "type": "object",
      "properties": {
